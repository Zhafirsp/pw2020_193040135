		...
		<body>
			<table border="1" cellspacing="0" cellpadding="10">
				...
				<tr>
					...
					<td><?php echo "Rp. ".$bag[0][2] ?></td>
					<td><?php echo "Rp. ".$bag[0][3] ?></td>
				</tr>
				<tr>
					<td>2</td>
					<td><?php echo $bag[1][0] ?></td>
					<td><?php echo $bag[1][1] ?></td>
					<td><?php echo "Rp. ".$bag[1][2] ?></td>
					<td><?php echo "Rp. ".$bag[1][3] ?></td>
				</tr>
				<tr>
					<td>3</td>
					<td><?php echo $bag[2][0] ?></td>
					<td><?php echo $bag[2][1] ?></td>
					<td><?php echo "Rp. ".$bag[2][2] ?></td>
					<td><?php echo "Rp. ".$bag[2][3] ?></td>
				</tr>
				<tr>
					<td>4</td>
					<td><?php echo $bag[3][0] ?></td>
					<td><?php echo $bag[3][1] ?></td>
					<td><?php echo "Rp. ".$bag[3][2] ?></td>
					<td><?php echo "Rp. ".$bag[3][3] ?></td>
				</tr>
				<tr>
					<td>5</td>
					<td><?php echo $bag[4][0] ?></td>
					<td><?php echo $bag[4][1] ?></td>
					<td><?php echo "Rp. ".$bag[4][2] ?></td>
					<td><?php echo "Rp. ".$bag[4][3] ?></td>
				</tr>
				<tr>
					<td>6</td>
					<td><?php echo $bag[5][0] ?></td>
					<td><?php echo $bag[5][1] ?></td>
					<td><?php echo "Rp. ".$bag[5][2] ?></td>
					<td><?php echo "Rp. ".$bag[5][3] ?></td>
				</tr>
				<tr>
					<td>7</td>
					<td><?php echo $bag[6][0] ?></td>
					<td><?php echo $bag[6][1] ?></td>
					<td><?php echo "Rp. ".$bag[6][2] ?></td>
					<td><?php echo "Rp. ".$bag[6][3] ?></td>
				</tr>
				<tr>
					<td>8</td>
					<td><?php echo $bag[7][0] ?></td>
					<td><?php echo $bag[7][1] ?></td>
					<td><?php echo "Rp. ".$bag[7][2] ?></td>
					<td><?php echo "Rp. ".$bag[7][3] ?></td>
				</tr>
				<tr>
					<td>#</td>
